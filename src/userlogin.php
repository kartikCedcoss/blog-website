...
try {
    ...
    if($v['passw']!=$lpass ){
    echo '<div class="alert alert-danger  " id="wpass" role="alert">
    Wrong  Password
    </div>';
   }
   elseif( $v['passw']==$lpass &&  $v['email'] != $eadd){
    echo '<div class="alert alert-danger" id="wemail" role="alert">
    Wrong Email 
    </div>';
   }

   else{
      if( $v['userstatus']=="pending" || $v['userrole'] !="user" ){
        echo '<div class="alert alert-danger" id="userpen" role="alert">
        You Are In Pending State!
        </div>';
      }
     

      else if($v['userstatus']=="approved" && $v['userrole'] == "user"){
